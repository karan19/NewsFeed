...
import { captureTransformer, buildUnifiedRecord, extractIdForDelete } from '../../shared/transformers';
...
async function processRecord(record: DynamoDBRecord): Promise<void> {
  ...
  try {
    if (eventType === 'REMOVE') {
      ...
      const originalId = extractIdForDelete(captureTransformer, keys, oldImage);
